...
public class DrawImageController{
    ...
    @ResponseBody
    public void drawImage(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException {
        //1.在内存中创建一张图片
        ...
        //7.将随机数存在session中
        request.getSession().setAttribute(Constance.CHECK_CODE, random);
