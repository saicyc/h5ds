...
define(function(require,exports,module){
	...
	exports.obj = {
		...
		_basicSetBoxText :  '<div class="set-layer-size">'+
							...
							'    &nbsp;&nbsp;| &nbsp;&nbsp;'+
							'    <a id="font_link" class="{{font_link}}"><i class="fa fa-chain"></i></a>'+
							'    <a id="font_breakLink"><i class="fa fa-chain-broken"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'+
							...
							'  </span>'+
							'</div>'+
							'<div class="text-area" id="textLayerArea" contenteditable="true"></div>',
	//iframe框
	_basicSetBoxIframe :'<div class="set-layer-size">'+
							...
							'</div>'+
							'<div class="pw-util">'+
							'	<input type="text" class="m-input" placeholder="请输入带http:// 的网址" id="iframeSrc" />'+
							'</div>',
	//form框
	_basicSetBoxForm :'<div class="set-layer-size">'+
							'	<p>宽：<input type="text" class="cleft" id="text_box_width" value="{{box_width}}"> px</p>'+
							' 	<p>高：<input type="text" class="cleft" id="text_box_height" value="{{box_height}}"> px</p>'+
							'</div>'+
							'<div class="pw-util">'+
							'	<div class="form-box clearfix">'+
							'		选择表单类型：（输入框，文本框，单选，多选，下拉框）<br/>'+
							'		<ul class="select-form clearfix">'+
							'			<li data-type="g-input"><a href="javascript:;"><i class="iconfont icon-wenbenkuang"></i><span>输入框</span></a></li>'+
							'			<li data-type="g-textarea"><a href="javascript:;"><i class="iconfont icon-duoxingwenbenkuang"></i><span>文本框</span></a></li>'+
							'			<li data-type="g-radio"><a href="javascript:;"><i class="iconfont icon-danxuan"></i><span>单选</span></a></li>'+
							'			<li data-type="g-check"><a href="javascript:;"><i class="iconfont icon-duoxuan"></i><span>多选</span></a></li>'+
							'			<li data-type="g-select"><a href="javascript:;"><i class="iconfont icon-xiala"></i><span>下拉框</span></a></li>'+
							'		</ul>'+
							'	</div>'+
							'</div>',
	//选择换页的效果	//页面切换的 效果
