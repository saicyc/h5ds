...
define(function(require,exports,module){
	...
	var iniFun = function(){
		...
		//鼠标右键注册
		var layerMouseRightEvent = function(e){
		...
		var mouseRightBtnEvent_page = function(){
			...
			//保存为模板
			var saveAsMoban = function(shtml,file){
				var $fixedBox = $("#fixedBox");
				var $infoBox = $("#infoBox");
				$.ajax({
					url: '/app/saveSingleTemplate',
					type: 'POST',
					data: {html: shtml, file : file },
					beforeSend:function(){
			...
			$("#mrbp-saveMoban").on("click",function(){
				var shtml = $("#pageListUl").find(".active").find("input").attr("data-html");
